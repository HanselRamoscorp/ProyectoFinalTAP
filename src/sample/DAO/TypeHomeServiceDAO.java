...
public class TypeHomeServiceDAO {

    Connection conn;

    private static ObservableList<sample.Modelos.TypeHomeService> data = FXCollections.observableArrayList();

    public TypeHomeServiceDAO(Connection conn) { this.conn = conn; }

    public static void addTransaction(sample.Modelos.TypeHomeService customer)
    {
        data.add(customer);
    }
    ...
    public List<sample.Modelos.TypeHomeService> findAll() {
        ...
        try {
            ...
            while(rs.next()) {
                p = new sample.Modelos.TypeHomeService(
                        rs.getInt("id_TypeHS"),
                        rs.getString("type")
                );
                TypeHomeService.add(p);
            }
            rs.close();
            st.close();
        ...
        return TypeHomeService;
    }


    public ObservableList<sample.Modelos.TypeHomeService> fetchAll() {
        ObservableList<sample.Modelos.TypeHomeService> TypeHomeService = FXCollections.observableArrayList();
        try {
    ...
    public sample.Modelos.TypeHomeService fetch(int trans_id) {
        ResultSet rs = null;
...
/*
    ...
    public Boolean insert(sample.Modelos.TypeHomeService customer) {
        try {
    ...
    public Boolean update(sample.Modelos.TypeHomeService customer) {
        try {
